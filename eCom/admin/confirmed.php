...
<section>
  <div class="myordersnav">
    ...
    <li><a class="active" href="confirmed.php">Confirmed</a></li>
  ...
  <div class="product-display">
    <table class="product-display-table order-table">
      ...
      <?php
        ...
        $query = "SELECT * FROM orders WHERE orderStatus = 'Confirm'
        ...
        if ($result->num_rows > 0) {
          ...
          while ($rows = $result->fetch_assoc()) {
            ...
            if ($orderId !== $currentOrderId) {
              ...
              echo '<tr class="order-group ' . $rowClass . '"><td colspan="8">Order Reference Number: ' . '<strong style="color:lightseagreen;">'. $orderId . '</strong></td>';
              echo '<form id="orderForm' . $orderId . '" class="orderForm" action="../request/update_order_status.php" method="post">';
              echo '<input type="hidden" name="orderId" value="' . $orderId . '">';
              echo '<td><input type="text" name="shipnum" value="" class="shipnum"></td>';
              echo '<td>';
              ...
              echo '<option value="Shipped"' . ($orderStatus == 'Shipped' ? ' selected' : '') . '>Ship</option>';
              echo '</select>';
