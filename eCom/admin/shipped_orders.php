      ...
      <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while ($rows = $result->fetch_assoc()) {
                ...
                $shipnum = htmlspecialchars($rows['shipping_tracking_number']);
                ...
                if ($orderId !== $currentOrderId) {
                    ...
                    echo '<tr class="order-group ' . $rowClass . '"><td colspan="10">Order Reference Number: ' . '<strong style="color:lightseagreen;">'. $orderId . '</strong></td><td>';
                    echo '</td></tr>';
                } else {
                    $rowClass = $isEven ? 'even' : 'odd';
                }
